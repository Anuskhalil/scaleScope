...
import { Mail, Lock, User, Zap, ArrowRight, AlertCircle, CheckCircle, Briefcase } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  async function handleOAuthSignIn(provider) {
    try {
      ...
      setMsg(err.message || 'OAuth sign-in failed');
      setLoading(false);
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center p-4 py-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  id="user_type"
                  required
                  className="w-full pl-10 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all appearance-none bg-white"
